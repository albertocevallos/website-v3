...
import { allBlogRoutes, blogRoutes } from "@utils/blogRoutes";
...
export function BlogDocsPage({ children }: { children: React.ReactNode }) {
	return (
		<MobileMenuProvider>
			<PrimitivesHeader />
			...
			<Flex>
				...
				<DocsPageWrapper>
					...
					<DocsPagination allRoutes={allBlogRoutes} />
					<EditPageLink />
				</DocsPageWrapper>
			</Flex>
		</MobileMenuProvider>
